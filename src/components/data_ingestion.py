...
if __name__=="__main__":
    ...
    train_arr,test_arr, extra=data_transormation.initiate_data_transformation(train_data,test_data)

    model_trainer=ModelTrainer()
    print(model_trainer.iniate_model_trainer(train_arr,test_arr))
